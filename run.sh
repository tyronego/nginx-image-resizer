...
sed -i -e "s/\${MEMORY_SIZE}/$DEFAULT_MEMORY_SIZE/" /etc/nginx/nginx.conf
sed -i -e "s/\${CACHE_NAME}/$DEFAULT_CACHE_NAME/" /etc/nginx/nginx.conf
sed -i -e "s/\${CACHE_SIZE}/$DEFAULT_CACHE_SIZE/" /etc/nginx/nginx.conf
sed -i -e "s/\${INACTIVE_TIME}/$DEFAULT_INACTIVE_TIME/" /etc/nginx/nginx.conf
